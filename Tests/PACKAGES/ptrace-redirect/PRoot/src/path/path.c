...
{
    printf("join_paths: recieved integer %i\n\n", number_paths);
    printf("join_paths: recieved char %c\n\n", result);
    printf("join_paths: recieved string %s\n\n", result);
	va_list paths;
	size_t length;
	int status;
	int i;
...
{
    printf("which: recieved char %c\n\n", paths);
    printf("which: recieved string %s\n\n", paths);
    printf("which: recieved char %c\n\n", host_path);
    printf("which: recieved string %s\n\n", host_path);
    printf("which: recieved char %c\n\n", command);
    printf("which: recieved string %s\n\n", command);
...
{
    printf("realpath2: recieved char %c\n\n", host_path);
    printf("realpath2: recieved string %s\n\n", host_path);
    printf("realpath2: recieved char %c\n\n", path);
    printf("realpath2: recieved string %s\n\n", path);
	int status;
...
{
    printf("getcwd2: recieved char %c\n\n", guest_path);
    printf("getcwd2: recieved string %s\n\n", guest_path);
	if (tracee == NULL) {
...
{
    printf("readlink_proc_pid_fd: recieved char %c\n\n", path);
    printf("readlink_proc_pid_fd: recieved string %s\n\n", path);
...
{
    printf("translate_path: recieved char %c\n\n", result);
    printf("translate_path: recieved string %s\n\n", result);
    printf("translate_path: recieved char %c\n\n", user_path);
    printf("translate_path: recieved string %s\n\n", user_path);
...
{
    printf("detranslate_path: recieved char %c\n\n", path);
    printf("detranslate_path: recieved string %s\n\n", path);
...
{
    printf("list_open_fd_callback: recieved char %c\n\n", path);
    printf("list_open_fd_callback: recieved string %s\n\n", path);
...
{
    printf("substitute_path_prefix: recieved char %c\n\n", path);
    printf("substitute_path_prefix: recieved string %s\n\n", path);
    printf("substitute_path_prefix: recieved char %c\n\n", new_prefix);
    printf("substitute_path_prefix: recieved string %s\n\n", new_prefix);
	size_t path_length;
	size_t new_length;
