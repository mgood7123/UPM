...
int main(void)
{
 ...
 call_int attroff (0);
 call_# 41 "_21908.c" 3 4;
 call_ ((void *)0);
 call_# 41 "_21908.c";
 call_int attron (0);
 call_# 47 "_21908.c" 3 4;
 call_ ((void *)0);
 call_# 47 "_21908.c";
 call_int attrset (0);
 ...
 call_# 336 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 336 "_21908.c";
 call_ has_colors ();
 call_# 342 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 342 "_21908.c";
 call_ has_ic ();
 call_# 348 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 348 "_21908.c";
 call_ has_il ();
 call_int hline (a1, 0);
 call_void idcok (WINDOW * a1, ;
 call_# 360 "_21908.c" 3 4;
 call_ ;
 call_# 360 "_21908.c";
 call_ 0);
 call_int idlok (WINDOW * a1, ;
 call_# 367 "_21908.c" 3 4;
 call_ ;
 call_# 367 "_21908.c";
 call_ 0);
 call_void immedok (WINDOW * a1, ;
 call_# 373 "_21908.c" 3 4;
 call_ ;
 call_# 373 "_21908.c";
 call_ 0);
 call_chtype inch ();
 ...
 call_void use_env (;
 call_# 1197 "_21908.c" 3 4;
 call_ ;
 call_# 1197 "_21908.c";
 call_ 0);
 call_void use_tioctl (;
 call_# 1204 "_21908.c" 3 4;
 call_ ;
 call_# 1204 "_21908.c";
 call_ 0);
 call_int vidattr (0);
 ...
 call_# 1285 "_21908.c" 3 4;
 call_ ((void *)0);
 call_# 1285 "_21908.c";
 call_int wattroff (WINDOW * a1, 0);
 call_# 1291 "_21908.c" 3 4;
 call_ ((void *)0);
 call_# 1291 "_21908.c";
 ...
 call_# 1654 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1654 "_21908.c";
 call_ is_cleared (WINDOW * 0);
 call_# 1660 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1660 "_21908.c";
 call_ is_idcok (WINDOW * 0);
 call_# 1666 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1666 "_21908.c";
 call_ is_idlok (WINDOW * 0);
 call_# 1672 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1672 "_21908.c";
 call_ is_immedok (WINDOW * 0);
 call_# 1678 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1678 "_21908.c";
 call_ is_keypad (WINDOW * 0);
 call_# 1684 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1684 "_21908.c";
 call_ is_leaveok (WINDOW * 0);
 call_# 1690 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1690 "_21908.c";
 call_ is_nodelay (WINDOW * 0);
 call_# 1696 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1696 "_21908.c";
 call_ is_notimeout (WINDOW * 0);
 call_# 1702 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1702 "_21908.c";
 call_ is_pad (WINDOW * 0);
 call_# 1708 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1708 "_21908.c";
 call_ is_scrollok (WINDOW * 0);
 call_# 1714 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1714 "_21908.c";
 call_ is_subwin (WINDOW * 0);
 call_# 1720 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1720 "_21908.c";
 ...
 call_# 1932 "_21908.c" 3 4;
 call_ ;
 call_# 1932 "_21908.c";
 call_ 0);
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1940 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1940 "_21908.c";
...
#endif
 call_# 2448 "_21908.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 2448 "_21908.c";
 call_ mouse_trafo (* a1, * a2, ;
 call_# 2448 "_21908.c" 3 4;
 call_ ;
 call_# 2448 "_21908.c";
 call_ 0);
