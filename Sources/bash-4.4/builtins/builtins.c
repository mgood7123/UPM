...
struct builtin static_shell_builtins[] = {
  ...
  { "read2", read_builtin, BUILTIN_ENABLED | STATIC_BUILTIN, read2_doc,
     N_("read2 [-ers] [-a array] [-d delim] [-i text] [-n nchars] [-N nchars] [-p prompt] [-t timeout] [-u fd] [name ...]"), (char *)NULL },
