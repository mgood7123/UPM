...
XS_EUPXS(XS_threads_self)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1241 "threads.xs"
        char *classname;
        ithread *thread;
#line 1422 "threads.c"
#line 1244 "threads.xs"
        /* Class method only */
...
XS_EUPXS(XS_threads_tid)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1259 "threads.xs"
        ithread *thread;
#line 1448 "threads.c"
#line 1261 "threads.xs"
...
XS_EUPXS(XS_threads_detach)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1403 "threads.xs"
        ithread *thread;
        int detach_err;
        dMY_POOL;
#line 1623 "threads.c"
#line 1407 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS_EUPXS(XS_threads__handle)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1603 "threads.xs"
        ithread *thread;
#line 1865 "threads.c"
#line 1605 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
#ifdef WIN32
...
XS_EUPXS(XS_threads_get_stack_size)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1618 "threads.xs"
        IV stack_size;
        dMY_POOL;
#line 1890 "threads.c"
#line 1621 "threads.xs"
        PERL_UNUSED_VAR(items);
        if (sv_isobject(ST(0))) {
            /* $thr->get_stack_size() */
...
XS_EUPXS(XS_threads_set_stack_size)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1637 "threads.xs"
        IV old_size;
        dMY_POOL;
#line 1918 "threads.c"
#line 1640 "threads.xs"
        if (items != 2) {
...
XS_EUPXS(XS_threads_is_running)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1659 "threads.xs"
        ithread *thread;
#line 1948 "threads.c"
#line 1661 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_is_joinable)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1689 "threads.xs"
        ithread *thread;
#line 1996 "threads.c"
#line 1691 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_set_thread_exit_only)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1721 "threads.xs"
        ithread *thread;
#line 2046 "threads.c"
#line 1723 "threads.xs"
        if (items != 2) {
...
XS_EUPXS(XS_threads_error)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1739 "threads.xs"
        ithread *thread;
        SV *err = NULL;
#line 2074 "threads.c"
#line 1742 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
