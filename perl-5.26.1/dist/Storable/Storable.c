...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 6668 "Storable.xs"
  init_perinterp(aTHX);
#line 6808 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV *	RETVAL;
#line 6719 "Storable.xs"
  RETVAL = pretrieve(aTHX_ f);
#line 6877 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6727 "Storable.xs"
  RETVAL = mretrieve(aTHX_ sv);
#line 6897 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6735 "Storable.xs"
  RETVAL = dclone(aTHX_ sv);
#line 6917 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    SP -= items;
    {
#line 6745 "Storable.xs"
  bool result;
#line 6937 "Storable.c"
#line 6747 "Storable.xs"
  if (ix) {
   dSTCXT;
