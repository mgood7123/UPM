...
XS_EUPXS(XS_Devel__PPPort_PL_parser)
{
    ...
    {
	SV *	RETVAL;
#line 2357 "RealPPPort.xs"
                RETVAL = newSViv(PL_parser != NULL);
#line 4494 "RealPPPort.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 2391 "RealPPPort.xs"
                int count = 0;
#line 4576 "RealPPPort.c"
#line 2393 "RealPPPort.xs"
