...
XS_EUPXS(XS_Scalar__Util_weaken)
{
	...
	SV *	sv = ST(0)
;
#line 1234 "ListUtil.xs"
#ifdef SvWEAKREF
    sv_rvweaken(sv);
#else
    croak("weak references are not implemented in this release of perl");
#endif
#line 1585 "ListUtil.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Scalar__Util_unweaken)
{
	...
	SV *	sv = ST(0)
;
#line 1245 "ListUtil.xs"
    SV *tsv;
#line 1602 "ListUtil.c"
#line 1247 "ListUtil.xs"
#ifdef SvWEAKREF
...
;
	int	RETVAL;
	dXSTARG;
#line 1294 "ListUtil.xs"
    SvGETMAGIC(sv);
    RETVAL = SvREADONLY(sv);
#line 1675 "ListUtil.c"
...
;
	SV *	code = ST(1)
;
#line 1381 "ListUtil.xs"
    SV *cv; /* not CV * */
#line 1815 "ListUtil.c"
#line 1383 "ListUtil.xs"
    SvGETMAGIC(code);
    if(!SvROK(code))
...
;
	SV *	sub = ST(1)
;
#line 1408 "ListUtil.xs"
    CV *cv = NULL;
    GV *gv;
    HV *stash = CopSTASH(PL_curcop);
    char *s, *end = NULL;
    MAGIC *mg;
#line 1862 "ListUtil.c"
#line 1414 "ListUtil.xs"
...
XS_EUPXS(XS_Sub__Util_subname)
{
	...
	SV *	code = ST(0)
;
#line 1517 "ListUtil.xs"
    CV *cv;
    GV *gv;
#line 1983 "ListUtil.c"
#line 1520 "ListUtil.xs"
...
#  endif
        ...
        XSANY.any_i32 = 2;
        cv = newXSproto_portable("List::Util::uniqnum", XS_List__Util_uniq, file, "@");
        XSANY.any_i32 = 0;
