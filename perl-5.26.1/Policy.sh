...
case "$perladmin" in
'') perladmin='smallville7123@gmail.com' ;;
esac
...
'') if test "./perl5.26.1" = ".../.."; then
	installprefix="$prefix"
    else
	installprefix='./perl5.26.1'
    fi
    ;;
esac
...
#     ./perl5.26.1, so it isn't included here either.
#
...
privlib='.../../lib/5.26.1'
# archlib='.../../lib/5.26.1/i686-linux-thread-multi-quadmath'
# man1dir='.../../man/man1'
# man3dir='.../../man/man3'
# man1ext='1'
# man3ext='3'
...
sitelib='.../../lib/site_perl/5.26.1'
# sitearch='.../../lib/site_perl/5.26.1/i686-linux-thread-multi-quadmath'
# siteman1dir='.../../man/man1'
# siteman3dir='.../../man/man3'
# sitehtml1dir=''
# sitehtml3dir=''
# vendorbin='.../../vendor/bin'
# vendorscript='.../../vendor/bin'
# Preserving custom vendorlib
vendorlib='.../../vendor/lib/vendor_perl/5.26.1'
# vendorarch='.../../vendor/lib/vendor_perl/5.26.1/i686-linux-thread-multi-quadmath'
# vendorman1dir='.../../vendor/man/man1'
# vendorman3dir='.../../vendor/man/man3'
