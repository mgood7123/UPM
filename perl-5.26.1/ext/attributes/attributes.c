...
XS_EUPXS(XS_attributes__fetch_attrs)
{
    ...
    SP -= items;
    {
#line 155 "attributes.xs"
    SV *rv, *sv;
    cv_flags_t cvflags;
#line 328 "attributes.c"
...
XS_EUPXS(XS_attributes__guess_stash)
{
    ...
    SP -= items;
    {
#line 186 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 371 "attributes.c"
...
XS_EUPXS(XS_attributes_reftype)
{
    ...
    SP -= items;
    {
#line 233 "attributes.xs"
    SV *rv, *sv;
    dXSTARG;
#line 430 "attributes.c"
