...
XS_EUPXS(XS_DynaLoader_dl_undef_symbols)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 246 "DynaLoader.xs"
#line 450 "DynaLoader.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_DynaLoader_dl_error)
{
    ...
    {
	SV *	RETVAL;
#line 269 "DynaLoader.xs"
    dMY_CXT;
    RETVAL = newSVsv(MY_CXT.x_dl_last_error);
#line 499 "DynaLoader.c"
...
#line 159 "DynaLoader.xs"
    (void)dl_private_init(aTHX);

#if XSubPPtmpAAAA
#endif
#line 577 "DynaLoader.c"
