...
"i686-linux-thread-multi-quadmath-4.9.20-nrj-desktop-1rosa-i586" or
	die "Errno architecture (i686-linux-thread-multi-quadmath-4.9.20-nrj-desktop-1rosa-i586) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
