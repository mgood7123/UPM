...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.26.1/i686-linux-thread-multi-quadmath'),
    archname => 'i686-linux-thread-multi-quadmath',
    cc => 'cc',
    d_readlink => 'define',
    d_symlink => 'define',
    dlext => 'so',
    ...
    libpth => '~/perllib /usr/local/lib /usr/lib /lib /usr/local/lib /usr/lib',
    osname => 'linux',
    osvers => '4.9.20-nrj-desktop-1rosa-i586',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.26.1'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.26.1/i686-linux-thread-multi-quadmath'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.26.1'),
    so => 'so',
    useithreads => 'define',
